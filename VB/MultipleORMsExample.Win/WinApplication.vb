...
Namespace MultipleORMsExample.Win
    Partial Public Class MultipleORMsExampleWindowsFormsApplication
        ...
        Protected Overrides Sub CreateDefaultObjectSpaceProvider(ByVal args As CreateCustomObjectSpaceProviderEventArgs)
            ...
            ConfigurationManager.ConnectionStrings("ConnectionStringXpo").ConnectionString, Nothing))
            args.ObjectSpaceProviders.Add(New EFObjectSpaceProviderCF(GetType(MyDbContext), CType(TypesInfo, TypesInfo), Nothing, _
            ConfigurationManager.ConnectionStrings("ConnectionStringEF").ConnectionString))
        End Sub

        Private Sub MultipleORMsExampleWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
            ...
            End If
        End Sub
        Private Sub MultipleORMsExampleWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs) Handles MyBase.CustomizeLanguagesList
