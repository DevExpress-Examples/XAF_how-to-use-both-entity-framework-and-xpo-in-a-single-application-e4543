...
Namespace MultipleORMsExample.Win
    Partial Public Class MultipleORMsExampleWindowsFormsApplication
        ...
        Protected Overrides Sub CreateDefaultObjectSpaceProvider(ByVal args As CreateCustomObjectSpaceProviderEventArgs)
            ...
            args.ObjectSpaceProviders.Add(New EFObjectSpaceProviderCF(GetType(MyDbContext), CType(TypesInfo, TypesInfo), Nothing, ConfigurationManager.ConnectionStrings("ConnectionStringEF").ConnectionString))
        End Sub
